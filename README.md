...
stateful components are components that use useState can change an object's state, and functional components are components that accept props and returns a react element
2. When does a componentWillMount function be called? What about a componentWillUpdate?
componentWillMount be called most likely inside of a handleChanges function and componetWillUpdate be called inside of a handleSubmit function
3. Define stateful logic.
It's the behaviour that our hooks will have 
4. What are the three step of creating a successful test? What is done in each phase?
arrange -> render the page
act-> find the elements in the webpage that we want to check 
assert-> check if they were rendered in the page
